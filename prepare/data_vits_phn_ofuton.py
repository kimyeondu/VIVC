...
class SingInput(object):
    ...
    def parseInput(self, singinfo: str):
        ...
        note_ids = self.notes_to_id(note)
        # convert into float
...
if __name__ == "__main__":
    output_path = "../VISinger_ofuton_data/label_vits_phn/"
    wav_path = "../VISinger_ofuton_data/wav_dump_24k/"
    ...
    fo = open("../VISinger_ofuton_data/transcriptions.txt", "r+")
    ...
    while True:
        ...
        print(
            f"{path_wave}|{path_label}|{path_label_dur}|{path_score}|{path_score_dur}|{path_pitch}|{path_slurs}",
            file=vits_file,
        )
